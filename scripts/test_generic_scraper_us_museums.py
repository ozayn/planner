#!/usr/bin/env python3
"""
Test and improve the generic scraper on US museums (excluding DC)
Focus on major US museums to improve the generic scraper
"""
import sys
import os
import json
...
# US Museums to test (excluding DC)
US_MUSEUMS = [
    # New York
    ...
    {'name': 'American Museum of Natural History', 'city': 'New York', 'url': 'https://www.amnh.org'},
    ...
    {'name': 'San Francisco Museum of Modern Art (SFMOMA)', 'city': 'San Francisco', 'url': 'https://www.sfmoma.org'},
    ...
    {'name': 'Museum of Contemporary Art Chicago', 'city': 'Chicago', 'url': 'https://www.mcachicago.org'},
    
    # Boston
    {'name': 'Museum of Fine Arts Boston', 'city': 'Boston', 'url': 'https://www.mfa.org'},
    {'name': 'Isabella Stewart Gardner Museum', 'city': 'Boston', 'url': 'https://www.gardnermuseum.org'},
    
    # Philadelphia
    {'name': 'Philadelphia Museum of Art', 'city': 'Philadelphia', 'url': 'https://www.philamuseum.org'},
    
    # Baltimore
    {'name': 'Baltimore Museum of Art', 'city': 'Baltimore', 'url': 'https://artbma.org'},
    
    # Miami
    {'name': 'Pérez Art Museum Miami (PAMM)', 'city': 'Miami', 'url': 'https://www.pamm.org'},
]

def test_museum_scraping(museum_info, scraper):
    """Test scraping a single museum and return detailed results"""
    results = {
...
def main():
    """Main test function"""
    print("🧪 Generic Scraper - US Museums Test")
    print("=" * 80)
    print(f"Testing {len(US_MUSEUMS)} US museums (excluding DC)")
    print("=" * 80)
    
    scraper = GenericVenueScraper()
    all_results = []
    
    for museum_info in US_MUSEUMS:
    ...
    if successful:
        ...
        for result in successful:
            print(f"   {result['museum']} ({result['city']}): {result['events_found']} events")
    ...
    output_file = 'generic_scraper_us_museums_test_results.json'
