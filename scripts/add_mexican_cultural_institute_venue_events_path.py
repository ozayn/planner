#!/usr/bin/env python3
"""
Add events path to Mexican Cultural Institute venue's additional_info (for venue scraping)
"""
...
def add_venue_events_path():
    """Add events path to Mexican Cultural Institute venue"""
    print("🏛️ Adding events path to Mexican Cultural Institute venue...")
    ...
    with app.app_context():
        try:
            ...
            if not venue:
                print("❌ Mexican Cultural Institute venue not found")
                return False
            ...
            print(f"✅ Added events path to Mexican Cultural Institute venue")
