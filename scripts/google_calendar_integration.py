    ...
    try:
        ...
        if venue_data:
            ...
            if venue_data.get('address'):
                description_parts.append(f"Address: {venue_data['address']}")
        ...
        if extracted_data.url:
            description_parts.append(f"More info: {extracted_data.url}")
        ...
        if extracted_data.start_date:
            if extracted_data.start_time:
                start_datetime = datetime.combine(extracted_data.start_date, extracted_data.start_time)
            else:
                start_datetime = datetime.combine(extracted_data.start_date, time(9, 0))  # Default to 9 AM
            ...
            if extracted_data.end_time:
                end_datetime = datetime.combine(end_date, extracted_data.end_time)
            elif extracted_data.end_date:
                end_datetime = datetime.combine(end_date, time(17, 0))  # Default to 5 PM
            else:
